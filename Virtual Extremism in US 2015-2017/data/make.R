...
write.csv(da37679.0001, "Virtual Extremism in US 2015-2017/data/survey_data_1")
write.csv(da37679.0002, "Virtual Extremism in US 2015-2017/data/survey_data_2")
write.csv(da37679.0003, "Virtual Extremism in US 2015-2017/data/survey_data_3")